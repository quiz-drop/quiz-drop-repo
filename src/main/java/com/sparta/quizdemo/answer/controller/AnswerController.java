...
public class AnswerController {
    ...
    public ResponseEntity<ApiResponseDto> postAnswer(@PathVariable Long cardNo, @RequestBody AnswerRequestDto answerRequestDto, @AuthenticationPrincipal UserDetailsImpl userDetails) {
