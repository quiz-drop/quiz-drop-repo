//package com.sparta.quizdemo.rank.service;
//
//import com.sparta.quizdemo.rank.dto.SearchRankResponseDto;
//import com.sparta.quizdemo.rank.repository.SearchRankRepository;
...
//
//    // 주문을 했을 때 해당 주문횟수 리스트를 출력하는 메서드
//    @Transactional
...
//        Double score = 0.0;
//        try {
//            // 주문을하면 주문 횟수를 value에 저장하고, score를 1 준다
...
//        Set<ZSetOperations.TypedTuple<String>> typedTuples = ZSetOperations.reverseRangeWithScores(key, 0, 4);  //score순으로 5개 보여줌
